...
######################## URL OF INDEX ###############################
  ...
  url(r'^wysiwyg_editor/(?P<path>.*)$','sharing.views.wysiwyg_editor'),


######################## URL OF FILE ###############################
  url(r'^update_file','sharing.views.update_file'),
  # url(r'^view_of_create_file','sharing.views.view_of_create_file'),
  # url(r'^create_file','sharing.views.create_file'),
...
urlpatterns += staticfiles_urlpatterns()</path></path></name></pre>