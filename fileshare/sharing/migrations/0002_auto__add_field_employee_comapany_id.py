...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'employee.comapany_id'
        db.add_column(u'sharing_employee', 'comapany_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['sharing.company']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'employee.comapany_id'
        db.delete_column(u'sharing_employee', 'comapany_id_id')
    ...
    models = {
        ...
        u'sharing.employee': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'comapany_id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sharing.company']"}),
