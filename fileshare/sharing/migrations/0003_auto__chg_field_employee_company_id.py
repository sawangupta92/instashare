...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'employee.company_id'
        db.alter_column(u'sharing_employee', 'company_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sharing.company'], null=True))

    def backwards(self, orm):

        # Changing field 'employee.company_id'
        db.alter_column(u'sharing_employee', 'company_id_id', self.gf('django.db.models.fields.related.ForeignKey')(default='3', to=orm['sharing.company']))
