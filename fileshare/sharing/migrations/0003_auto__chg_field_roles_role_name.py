...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'roles.role_name'
        db.alter_column(u'sharing_roles', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'roles.role_name'
        db.alter_column(u'sharing_roles', 'role_name', self.gf('django.db.models.fields.CharField')(max_length=50))
