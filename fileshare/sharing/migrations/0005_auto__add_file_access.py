...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'file_access'
        db.create_table(u'sharing_file_access', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sccess', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal(u'sharing', ['file_access'])
    ...
    def backwards(self, orm):
        # Deleting model 'file_access'
        db.delete_table(u'sharing_file_access')
    ...
    models = {
        ...
        u'sharing.file_access': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sccess': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'sharing.my_file': {
