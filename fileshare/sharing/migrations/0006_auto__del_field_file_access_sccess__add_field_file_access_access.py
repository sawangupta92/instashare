...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'file_access.sccess'
        db.delete_column(u'sharing_file_access', 'sccess')

        # Adding field 'file_access.access'
        db.add_column(u'sharing_file_access', 'access',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'file_access.sccess'
        db.add_column(u'sharing_file_access', 'sccess',
                      self.gf('django.db.models.fields.CharField')(default='public', max_length=50),
                      keep_default=False)

        # Deleting field 'file_access.access'
        db.delete_column(u'sharing_file_access', 'access')
    ...
    models = {
        ...
        u'sharing.file_access': {
            ...
            'employee_id': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['sharing.employee']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'sharing.my_file': {
