...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'employee.companyid'
        # db.delete_column(u'sharing_employee', 'companyid_id')

        # Adding field 'employee.company_id'
        db.add_column(u'sharing_employee', 'company_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='3', to=orm['sharing.company']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'employee.companyid'
        db.add_column(u'sharing_employee', 'companyid',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='3', to=orm['sharing.company']),
                      keep_default=False)

        # Deleting field 'employee.company_id'
        # db.delete_column(u'sharing_employee', 'company_id_id')
