...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'file_access.file_Id'
        db.add_column(u'sharing_file_access', 'file_Id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='2', to=orm['sharing.my_file']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'file_access.file_Id'
        db.delete_column(u'sharing_file_access', 'file_Id_id')
    ...
    models = {
        ...
        u'sharing.file_access': {
            ...
            'file_Id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sharing.my_file']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        u'sharing.my_file': {
