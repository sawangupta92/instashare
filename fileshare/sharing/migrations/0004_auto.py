...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field file_ta on 'my_file'
        m2m_table_name = db.shorten_name(u'sharing_my_file_file_ta')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field file_ta on 'my_file'
        db.delete_table(db.shorten_name(u'sharing_my_file_file_ta'))
    ...
    models = {
        ...
        u'sharing.my_file': {
            ...
            'file_ta': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['sharing.tag_file']", 'symmetrical': 'False'}),
